...
debug.win32:
	...
	nmake O="obj" CC="CL" CRLIB="C:\Users\Ad4m\Games\DEV\sdl2\advancedrogue58curses.lib shfolder.lib user32.lib Advapi32.lib" CFLAGS="-DWIZARD -nologo -IC:\Users\Ad4m\Games\DEV\sdl2\ -Ox -wd4033 -wd4716" $(PROGRAM)

dist.win32:
	nmake O="obj" RM="-del" clean
	nmake O="obj" CC="CL" CRLIB="C:\Users\Ad4m\Games\DEV\sdl2\advancedrogue58curses.lib shfolder.lib user32.lib Advapi32.lib" CFLAGS="-nologo -IC:\Users\Ad4m\Games\DEV\sdl2\ -Ox -wd4033 -wd4716" $(PROGRAM)
